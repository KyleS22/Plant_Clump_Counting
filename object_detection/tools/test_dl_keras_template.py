...
# ***** TODO ***** #
# Fill in this function so that it returns a temp dict from the input boxes as so
def get_boxes_from_model(boxes, min_score_thresh=0.5):
    '''
    Args:
    ...
    box_map = []
    for bbox in boxes:
        score = bbox.get_score() # TODO: Get your confidence score
        if score > min_score_thresh: # Pass confidence check
            tempDict = {}
            tempDict["ymin"] = bbox.get_ymin()   # TODO: Get your ymin
            tempDict["xmin"] = bbox.get_xmin()   # TODO: Get your xmin
            tempDict["ymax"] = bbox.get_ymax()   # TODO: Get your ymax
            tempDict["xmax"] = bbox.get_xmax()   # TODO: Get your xmax
            tempDict["class"] = bbox.get_class() # TODO: Get your class
...
def main(args):
    ...
    for filename in infiles:
        ...
        ## *** ACTUAL DETECTION *** ##
        boxes = get_model_boxes(infer_model, [image_np], ...) # TODO -- fill in your inference process
        ...
        boxesDL = get_boxes_from_model(boxes, min_score_thresh=BBOX_CONFIDENCE)
    ...
    argsString="Input Folder: {}\nOutput Folder: {}\nGround-truth Folder: {}\nMin Area Percent (alpha): {}\nMin Jaccard (IoU): {}\nMax Image Width: {}\n".format(infolder,outfolder,xmlfolder,BBOX_ALPHA,IOU_THRESH_MIN,MAXWIDTH)
    print(argsString)
