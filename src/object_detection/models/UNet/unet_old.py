'''
 ORIGINALLY FROM HERE: https://github.com/zizhaozhang/unet-tensorflow-keras/blob/37015016dc6dcba2753e8e9ed38c79f288b005a0/model.py
 * @author [Zizhao Zhang]
...
class UNet():
    ...
    def create_unet_model(self, img_shape, num_class):
