...
python encoder/train_runner.py ~/Plant_Counting_Data/combined_train/ --model_save_dir $SAVE_DIR --validation_data_dir ~/Plant_Counting_Data/combined_val --batch_size=32 --num_epochs $NUM_EPOCHS --model_name $MODEL_NAME
...
python validation_runner.py $MODEL_JSON_PATH ~/Plant_Counting_Data/combined_val $SAVE_DIR $TEST_NAME ENCODER --path_to_weights $MODEL_SAVE_PATH
