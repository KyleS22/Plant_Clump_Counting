...
python encoder/train_runner.py ~/Plant_Counting_Data/synthetic2_train/ --model_save_dir $SAVE_DIR --validation_data_dir ~/Plant_Counting_Data/synthetic2_val --batch_size=32 --num_epochs $NUM_EPOCHS --model_name $MODEL_NAME
